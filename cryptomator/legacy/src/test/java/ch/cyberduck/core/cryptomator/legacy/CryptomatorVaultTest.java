...
import static ch.cyberduck.core.cryptomator.legacy.CryptomatorVault.VAULT_VERSION;
import static org.junit.Assert.*;

public class CryptomatorVaultTest {
    ...
    public void testLoad() throws Exception {
        ...
        vault.load(session, new VaultCredentials("vault123"));
    ...
    public void testLoadInvalidPassphrase() throws Exception {
        ...
        assertThrows(CryptoAuthenticationException.class, () -> vault.load(session, new VaultCredentials("null")));
    }
    ...
    public void testCleartextSizeV6() throws Exception {
        ...
        final CryptomatorVault vault = new CryptomatorVault(
                home);
