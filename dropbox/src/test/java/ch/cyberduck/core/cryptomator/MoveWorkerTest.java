...
public class MoveWorkerTest extends AbstractDropboxTest {
    ...
    public void testMoveSameFolderCryptomator() throws Exception {
        ...
        cryptomator.getFeature(session, Delete.class, new DropboxDeleteFeature(session)).delete(Arrays.asList(target, vault), LoginCallback.noop, new Delete.DisabledCallback());
    }
    ...
    public void testMoveToDifferentFolderCryptomator() throws Exception {
        ...
        assertFalse(cryptomator.getFeature(session, Find.class, new DefaultFindFeature(session)).find(source));
        assertTrue(cryptomator.getFeature(session, Find.class, new DefaultFindFeature(session)).find(target));
        cryptomator.getFeature(session, Delete.class, new DropboxDeleteFeature(session)).delete(Arrays.asList(target, targetFolder, vault), LoginCallback.noop, new Delete.DisabledCallback());
    }
    ...
    public void testMoveFolder() throws Exception {
        ...
        cryptomator.getFeature(session, Delete.class, new DropboxDeleteFeature(session)).delete(Arrays.asList(fileRenamedInRenamedFolder, folderRenamed, vault), LoginCallback.noop, new Delete.DisabledCallback());
    }
    ...
    public void testMoveFileIntoVault() throws Exception {
        ...
        cryptomator.getFeature(session, Delete.class, new DropboxDeleteFeature(session)).delete(Arrays.asList(encryptedFile, encryptedFolder, vault), LoginCallback.noop, new Delete.DisabledCallback());
    ...
    public void testMoveFileOutsideVault() throws Exception {
        ...
        cryptomator.getFeature(session, Delete.class, new DropboxDeleteFeature(session)).delete(Arrays.asList(encryptedFolder, vault), LoginCallback.noop, new Delete.DisabledCallback());
        new DropboxDeleteFeature(session).delete(Arrays.asList(fileRenamed, clearFolder), LoginCallback.noop, new Delete.DisabledCallback());
        session.getRegistry().clear();
    }
    ...
    public void testMoveDirectoryOutsideVault() throws Exception {
        ...
        assertTrue(new DefaultFindFeature(session).find(fileRenamed));
        cryptomator.getFeature(session, Delete.class, new DropboxDeleteFeature(session)).delete(Collections.singletonList(vault), LoginCallback.noop, new Delete.DisabledCallback());
        new DropboxDeleteFeature(session).delete(Arrays.asList(fileRenamed, directoryRenamed), LoginCallback.noop, new Delete.DisabledCallback());
        session.getRegistry().clear();
    }
}
