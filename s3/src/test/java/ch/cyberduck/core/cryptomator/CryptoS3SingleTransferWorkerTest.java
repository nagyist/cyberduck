...
public class CryptoS3SingleTransferWorkerTest extends AbstractS3Test {
    ...
    public void testUpload() throws Exception {
        ...
        assertTrue(cryptomator.getFeature(session, Find.class, new S3FindFeature(session, acl)).find(dir1));
